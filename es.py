...
def main(argv):
    ...
    availableAlgos = ('OpenAI-ES','SSS', 'coevo2', 'coevo', "coevoarch2", 'coevoarch2multi', 'coevoarch2multirr')   # check whether the user specified a valid algorithm
    ...
    elif (algoname == 'archive'):
        from archive import Algo
    elif (algoname == 'archivestar'):
        from archivestar import Algo
    elif (algoname == 'maxsolvestar'):
        from maxsolvestar import Algo
    elif (algoname == 'generalist'):
        from generalist import Algo
